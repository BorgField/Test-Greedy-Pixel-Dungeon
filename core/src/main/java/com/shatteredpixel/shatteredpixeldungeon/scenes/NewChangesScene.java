...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.grpd.G_v0_1_X_Changes;
...
public class NewChangesScene extends PixelScene {
    ...
    public void create() {
        ...
        switch (changesSelected){
            case 0: default:
                G_v0_1_X_Changes.addAllChanges(changeInfos);
                break;
        }
        ...
        if (changesSelected == 0) {
            ChangeSelection selection1 = new ChangeSelection("ShatteredPD", Messages.get(this, "shpd")) {
                @Override
                public void onClick() {
            ...
            selection1.icon(new Image(Icons.get(Icons.SHPX)));
