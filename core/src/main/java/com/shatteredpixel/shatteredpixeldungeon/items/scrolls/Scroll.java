...
import com.shatteredpixel.shatteredpixeldungeon.events.ScrollUsedEvent;
...
import com.shatteredpixel.shatteredpixeldungeon.items.stones.StoneOfBlank;
...
public abstract class Scroll extends Item {
	...
	public void readAnimation() {
		...
		if (!anonymous) {
			...
			if (Random.Float() < talentChance) {
				// 发射卷轴使用事件（新事件系统）
				EventManager.emit(new ScrollUsedEvent(curUser, this, curUser.pos, talentFactor));
	...
	public static class ScrollToStone extends Recipe {
		...
		static {
			...
			stones.put(ScrollOfBlank.class,         StoneOfBlank.class);
		}
