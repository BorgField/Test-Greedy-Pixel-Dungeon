...
//        Dungeon.hero.exp = originalExp;
        Dungeon.hero.updateHT(true);
    }

    private static final String ORIGINAL_LEVEL = "originalLevel";
    private static final String ORIGINAL_EXP = "originalExp";
    ...
    public void storeInBundle(Bundle bundle) {
        ...
        bundle.put(ORIGINAL_EXP, originalExp);
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        originalExp = bundle.getInt(ORIGINAL_EXP);
